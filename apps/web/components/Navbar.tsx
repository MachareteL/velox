  ...
  const getStatusBadge = () => {
    switch (status) {
      ...
      case 'DISCONNECTED_NEED_QR':
        return (
          <div className="flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-semibold bg-amber-500/10 text-amber-400 border border-amber-500/20 shadow-inner">
            <span className="relative flex h-2 w-2">
      ...
      default:
        return (
          <div className="flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-semibold bg-slate-500/10 text-slate-400 border border-slate-500/20">
    ...
    <header className="sticky top-0 z-40 border-b border-gray-800/80 bg-gray-950/80 backdrop-blur-xl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-emerald-500 via-emerald-400 to-teal-300 p-0.5 shadow-lg shadow-emerald-500/20 flex items-center justify-center transition-transform hover:scale-105">
          ...
          <div>
            ...
            <p className="text-[11px] text-gray-400">Automação Inteligente de Convites</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div
            ...
            className={`cursor-pointer flex items-center gap-2.5 px-3 py-1.5 rounded-xl border text-xs font-semibold transition-all duration-300 select-none ${
              isActive
          ...
          >
            {/* Visual Slider Knob */}
            <div className={`w-8 h-4 rounded-full p-0.5 transition-colors duration-300 relative ${isActive ? 'bg-emerald-500' : 'bg-gray-700'}`}>
              <div className={`w-3 h-3 rounded-full bg-white shadow-md transform transition-transform duration-300 flex items-center justify-center ${isActive ? 'translate-x-4' : 'translate-x-0'}`}>
          ...
          <button
            onClick={onOpenQR}
            className="flex items-center gap-2 px-3.5 py-2 text-xs font-semibold rounded-xl bg-gradient-to-r from-emerald-600 to-emerald-500 hover:from-emerald-500 hover:to-emerald-400 text-white shadow-lg shadow-emerald-600/20 transition-all hover:scale-105 active:scale-95"
          >
